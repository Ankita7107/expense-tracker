    ...
    <div className="min-h-screen bg-sky-50 dark:bg-sky-950 flex items-center justify-center p-4">
      ...
      >
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-4xl font-black text-sky-950 dark:text-sky-50 tracking-tight">Expensy</h1>
          <p className="text-sky-400 font-bold uppercase tracking-[0.3em] text-xs mt-1">Sky Ledger Auth</p>
        </div>
